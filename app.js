...
class UIManager {
    ...
    renderLiveParserTable() {
        ...
        this.draftParsedItems.forEach((item, idx) => {
            ...
            const imgPreview = item.image ? `<img src="${this.escapeHTML(item.image)}" alt="preview" class="w-7 h-7 rounded object-cover border border-slate-700 inline-block mr-1">` : '';
